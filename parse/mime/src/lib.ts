...
/**
 * Namespace for all the types generated by Peggy.
 */
 ...
 *
 * @privateRemarks It's reexported as a const to add jsdoc to it
 */
 ...
 * @throws {@link SyntaxError} When the input doesn't match the expected grammar
...
>(
  input: string,
  options?: SniffOptions<TRule, TMultiParameter>,
): RuleResult<TMultiParameter>[TRule] => {
  assertSome(options, 'options', isObject, isUndef);
  assertOptionalProp(options, 'sniff', isTrue, 'options');
